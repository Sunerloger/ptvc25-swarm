...
namespace physics {
	...
	Terrain::Terrain(PhysicsSystem& physics_system) : ManagedPhysicsEntity(physics_system) {
		...
		BoxShapeSettings floor_shape_settings(Vec3(100.0_r, 1.0_r, 100.0_r));
		...
		body_settings = std::make_unique<BodyCreationSettings>(BodyCreationSettings(floor_shape, RVec3(0.0_r, -1.0_r, 0.0_r), Quat::sIdentity(), EMotionType::Static, Layers::NON_MOVING));
