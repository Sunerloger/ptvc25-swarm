...
namespace physics {
    ...
    PhysicsSimulation::PhysicsSimulation() : cPhysicsDeltaTime(1.0f / 60.0f), temp_allocator(TempAllocatorImpl(10 * 1024 * 1024)), 
    ...
    PhysicsSimulation::~PhysicsSimulation() {
        ...
        body_interface.RemoveBody(scene.getIdPlayer());
    ...
    void PhysicsSimulation::simulate() {
        ...
        RVec3 position = body_interface.GetCenterOfMassPosition(scene.getIdPlayer());
        Vec3 velocity = body_interface.GetLinearVelocity(scene.getIdPlayer());
