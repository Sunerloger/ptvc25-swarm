...
VkDescriptorSet ShadowMap::getDescriptorSet(int frameIndex) const {
    return shadowDescriptorSets[frameIndex];
}

VkDescriptorSetLayout ShadowMap::getDescriptorSetLayout() const {
...
void ShadowMap::bindDescriptorSet(VkCommandBuffer commandBuffer, VkPipelineLayout pipelineLayout, int frameIndex) const {
    vkCmdBindDescriptorSets(
        commandBuffer,
        VK_PIPELINE_BIND_POINT_GRAPHICS,
        pipelineLayout,
        2, // set 2 for shadow map
        1,
